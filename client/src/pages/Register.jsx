        ...
        <div className="fixed inset-0 flex justify-center items-center">
          <div className="bg-white w-4/5 h-4/5 rounded-lg shadow-lg flex overflow-hidden relative">
            <div
              ...
              style={{ backgroundImage: `url('https://img.freepik.com/free-vector/cute-man-lifting-barbell-gym-cartoon-vector-icon-illustration-people-sport-icon-concept-isolated_138676-6223.jpg')` }}
            ></div>
            ...
            <div className="w-1/2 bg-gray-900 p-6 text-white flex flex-col justify-center relative">
              ...
              <form className="space-y-4" onSubmit={handleRegister}>
                ...
                <div className="flex items-center space-x-2">
                  <input type="checkbox" id="terms" className="form-checkbox h-4 w-4 text-indigo-600" required />
